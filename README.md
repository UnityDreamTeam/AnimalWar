...
זוהי תמונה ממטלה מספר 4 של מפה מסויימת במשחק שלנו. כפי שניתן לראות במפה הגבולות הם הקווים האפורים ולא ניתן לעבור אותם. כמו כן קל לראות כי לא ניתן להסתכל על שום חלק בעולם מלבד הזירה עצמה.
* איך נראה מסך המשחק?
