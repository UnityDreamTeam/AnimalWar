...
### 1. נראות
![animal_war_map](https://user-images.githubusercontent.com/73671381/100557948-c9701500-32b4-11eb-996d-a72fb60f2c4a.jpg)  
זוהי תמונה ממטלה מספר 4 של מפה מסויימת במשחק שלנו.  
כפי שניתן לראות במפה הגבולות הם הקווים האפורים ולא ניתן לעבור אותם.  
כמו כן קל לראות כי לא ניתן להסתכל על שום חלק בעולם מלבד הזירה עצמה.  
